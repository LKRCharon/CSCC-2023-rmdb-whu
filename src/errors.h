...
class IndexEntryRepeatError : public RMDBError {
   public:
    IndexEntryRepeatError() : RMDBError("Index entry repeat") {}
};
...
class LoadNotMatchError : public RMDBError {
   public:
    LoadNotMatchError() : RMDBError("Load file and table do not match") {}
};
